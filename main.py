...
q01=form.text_input("Q1. ", placeholder="one line answer to q1", key="q01")
q02=form.text_input("Q2. ", placeholder="one line answer to q2", key="q02")
q03=form.text_input("Q3. ", placeholder="one line answer to q3", key="q03")
q04=form.text_input("Q4. ", placeholder="one line answer  to q4", key="q04")
...
q5_2=form.text_input("Q5.2 ", placeholder="one line answer  to q5.2", key="q05.2")
q5_3=form.text_input("Q5.3 ", placeholder="one line answer  to q5.3", key="q05.3")
q5_4=form.text_input("Q5.4 ", placeholder="one line answer  to q5.4", key="q05.4")
